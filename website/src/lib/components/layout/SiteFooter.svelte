<script lang="ts">
	...
	import FooterShapeGreen from '$lib/components/svg/FooterShapeGreen.svelte';
	import FooterShapeGreenMobile from '$lib/components/svg/FooterShapeGreenMobile.svelte';
...
<footer class="text-body-2 relative isolate overflow-hidden bg-grey-light">
	<div class="relative w-full max-w-360 mx-auto">
		<div aria-hidden="true" class="absolute inset-0 -z-10">
			<FooterShapeYellow class="hidden lg:block absolute top-0 -left-70" />
			<FooterShapeGreen class="hidden lg:block absolute -bottom-170.5 -right-47" />
			<FooterShapeGreenMobile class="lg:hidden absolute top-0 left-0" />
			<FooterShapeYellowMobile class="lg:hidden absolute bottom-0 left-0" />
		</div>

		<div
			class="px-base pt-6 lg:pt-9 grid grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-x-4 lg:gap-x-8 gap-y-10"
		>
			<div>
				{#if address.name}
		...
		<div
			class="flex items-center justify-center lg:justify-between gap-x-4 px-base pb-12.5 lg:pb-9 mt-12.5 lg:mt-2.5"
		>
