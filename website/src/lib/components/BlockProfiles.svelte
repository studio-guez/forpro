<script lang="ts">
    import type {IProfiles} from "$lib/interfaces/cmsApiResponse";
    ...
    <div class="app-grid--column-3 app-grid--sm--column-1">
        {#each content.content.profiles as profile}
            ...
            >
                ...
                <div class="s-profiles__profile__description">
                    {@html profile.description}
                </div>

                <div class="s-profiles__profile__links app-flex">
                    {#if (profile.mailto)}
                        <a href="mailto:{profile.mailto}" target="_blank" aria-label="Envoyer un e-mail">
                    ...
                    {/if}
                    {#if (profile.lien)}
                        <a href="{profile.lien}" target="_blank" aria-label="Voir le lien">
                            <svg xmlns="http://www.w3.org/2000/svg" height="48" viewBox="0 -960 960 960" width="48">
