  ...
  >
    <g>
      <g>
        ...
        <rect  class:is-over="{currentOverSection === 'FactoryLab'}"  on:mouseover="{() => currentOverSection = 'FactoryLab'}"          class="s-block-space-build--nav__svg-building-link HotelEntreprise" x="975" y="390" width="225" height="88" style="fill: var(--fp-color-hotel_entreprises);"/>
        <rect  class:is-over="{currentOverSection === 'foodlab'}"     on:mouseover="{() => currentOverSection = 'foodlab'}"             class="s-block-space-build--nav__svg-building-link FoodLab" x="70.0027" width="905.03136" height="69" style="fill: var(--fp-color-foodlab);"/>
        <rect  class:is-over="{currentOverSection === 'makerlab'}"    on:mouseover="{() => currentOverSection = 'makerlab'}"            class="s-block-space-build--nav__svg-building-link MakerLab" x="975" y="260" width="225" height="130" style="fill: var(--fp-color-makerlab);"/>
        <rect  class:is-over="{currentOverSection === 'learninglab'}" on:mouseover="{() => currentOverSection = 'learninglab'}"         class="s-block-space-build--nav__svg-building-link LearningLab" x="225" y="260" width="750" height="130" style="fill: var(--fp-color-learninglab);"/>
        <rect  class:is-over="{currentOverSection === 'grandlab'}"    on:mouseover="{() => currentOverSection = 'grandlab'}"            class="s-block-space-build--nav__svg-building-link GrandLab" y="260" width="225" height="130" style="fill: var(--fp-color-grandlab);"/>
        <rect  class:is-over="{currentOverSection === 'popup'}"       on:mouseover="{() => currentOverSection = 'popup'}"               class="s-block-space-build--nav__svg-building-link Accueil" y="390" width="225" height="88" style="fill: var(--fp-color-accueil);"/>
