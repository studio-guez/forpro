(function() {
  ...
  var _sfc_render = function render() {
    ...
    return _c("k-inside", [_c("k-header", [_vm._v(" Menu "), _c("k-button-group", { attrs: { "slot": "buttons" }, slot: "buttons" }, [_c("k-button", { attrs: { "icon": "check", "variant": "filled", "^": "" }, on: { "click": _vm.submit } }, [_vm._v(" Enregistrer ")]), _c("k-button", { attrs: { "icon": _vm.isGeneratingPDF ? "loader" : "wand", "disabled": _vm.isGeneratingPDF, "variant": "filled" }, on: { "click": _vm.generate } }, [_vm._v(" Générer PDF ")])], 1)], 1), _c("k-form", { attrs: { "fields": {
      textTitle1: {
        label: "Titre 1",
        type: "text",
        width: "1/2"
