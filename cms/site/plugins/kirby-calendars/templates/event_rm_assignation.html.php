    ...
    <tr>
        ...
        <td class="container">
            ...
            <div class="content">
                ...
                <span class="preheader">Un évènement vous a été retiré !</span>
                    ...
                    <tr>
                        <td class="wrapper align-center">
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <p>Vous n'etes <span style="color: red">plus assigné</span> à cet évènement:</p>
                                        <h1 style="font-weight: bold"><?= $startTime ?></h1>
                                    </td>
                                </tr>
                            </table>
                        </td>
