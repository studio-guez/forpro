    ...
    <tr>
        ...
        <td class="container">
            ...
            <div class="content">
                ...
                <span class="preheader">Un évènement vous a été attribué/partagé !</span>
                    ...
                    <tr>
                        <td class="wrapper align-center">
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <p>Utilisez le fichier en pièce jointe afin d'ajouter ce rendez-vous à votre calendrier.</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
