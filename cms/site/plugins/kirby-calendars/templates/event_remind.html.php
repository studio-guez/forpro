...
<head>
    ...
    <title>Forpro | Rappel de Rendez-vous</title>
    <style>
        /* -------------------------------------
            GLOBAL RESETS
        ------------------------------------- */
    ...
    <tr>
        ...
        <td class="container">
            ...
            <div class="content">
                ...
                <span class="preheader">Rappel de votre rendez-vous avec ForPro!</span>
                <table class="main">
                    ...
                    <tr>
                        <td class="wrapper align-center">
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <h1><strong>Rappel de Rendez-vous</strong></h1>
                                        ...
                                        <p>Une erreur dans la prise de rendez-vous? Il vous suffit simplement de <a href="mailto:info+rendez-vous@for-pro.ch" target="_blank">nous contactez à info+rendez-vous@for-pro.ch!</a></p>
                                    </td>
                                </tr>
                            </table>
                        </td>
