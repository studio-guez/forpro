(function() {
  ...
  var _sfc_render$1 = function render() {
    var _vm = this, _c = _vm._self._c;
    return _c("k-inside", [_c("k-header", [_vm._v(" Calendriers "), _c("k-button-group", { attrs: { "slot": "buttons" }, slot: "buttons" }, [_c("k-button", { attrs: { "text": "Ajouter", "variant": "filled", "icon": "add" }, on: { "click": function($event) {
      ...
      return _c("tr", { key: id }, [_c("td", { staticClass: "k-table-index-column", staticStyle: { "text-align": "center" } }, [_vm._v(" " + _vm._s(index) + " ")]), _c("td", { staticStyle: { "width": "10%" } }, [_vm._v(_vm._s(calendar.name))]), _c("td", { attrs: { "data-align": "center" } }, [_vm._v(_vm._s(calendar.nbrServices))]), _c("td", { attrs: { "data-align": "center" } }, [_c("k-button", { attrs: { "icon": calendar.scheduleState.icon, "theme": calendar.scheduleState.theme, "variant": "dimmed" } }, [_vm._v(" " + _vm._s(calendar.scheduleState.status) + " ")])], 1), _c("td", { attrs: { "title": calendar.ical } }, [_c("k-button", { on: { "click": function($event) {
  ...
  var _sfc_render = function render() {
    ...
    } } })], 1)], 1), _c("table", { staticClass: "k-table" }, [_c("thead", [_c("tr", [_c("th", { staticClass: "k-table-index-column", staticStyle: { "text-align": "center" } }, [_vm._v(" # ")]), _c("th", [_vm._v("Nom")]), _c("th", [_vm._v("Sujet")]), _c("th", [_vm._v("Horaire")]), _c("th", [_vm._v("Nom")]), _c("th", [_vm._v("Prénom")]), _c("th", [_vm._v("Email")]), _c("th", [_vm._v("Téléphone")]), _c("th", [_vm._v("Confirmé")]), _c("th", { staticClass: "k-table-index-column" })])]), _c("tbody", _vm._l(_vm.events, function(event, id, index) {
      return _c("tr", { key: id }, [_c("td", { staticClass: "k-table-index-column", staticStyle: { "text-align": "center" } }, [_vm._v(" " + _vm._s(index) + " ")]), _c("td", { staticStyle: { "width": "10%" }, attrs: { "title": event.name } }, [_vm._v(_vm._s(event.name))]), _c("td", { staticStyle: { "width": "10%" }, attrs: { "title": event.subject } }, [_vm._v(_vm._s(event.subject))]), _c("td", { attrs: { "title": _vm.formatDate(event.date) + " " + event.start_time + "-" + event.end_time, "data-align": "center" } }, [_vm._v(_vm._s(_vm.formatDate(event.date)) + " " + _vm._s(event.start_time) + "-" + _vm._s(event.end_time) + " ")]), _c("td", { attrs: { "title": event.lastname } }, [_vm._v(_vm._s(event.lastname))]), _c("td", { attrs: { "title": event.firstname } }, [_vm._v(_vm._s(event.firstname))]), _c("td", { attrs: { "title": event.email } }, [_vm._v(_vm._s(event.email))]), _c("td", { attrs: { "title": event.phone } }, [_vm._v(_vm._s(event.phone))]), _c("td", { attrs: { "data-align": "center" } }, [_c("k-button", { attrs: { "icon": _vm.getIsConfirmedIcon(event.is_confirmed), "theme": _vm.getIsConfirmedTheme(event.is_confirmed), "variant": "dimmed" } })], 1), _c("td", { staticClass: "k-table-options-column" }, [_c("k-options-dropdown", { attrs: { "options": [
        {
          text: "Modifier",
          icon: "edit",
          click: () => _vm.$dialog(`calendar/${id}/edit`)
