...
export_as_csv.short_description = "Exporter la sélection au format CSV"
...
class CSVExportAdmin(admin.ModelAdmin):
    def get_actions(self, request):
        ...
        if self.has_csv_permission(request):
            actions['export_as_csv'] = (export_as_csv, 'export_as_csv', "Exporter la sélection au format CSV")
        return actions
